...
class NamingClient
{
     ...
     * @return Beat|model\Host|Instance|InstanceList|model\Model|null
     */
    public static function get($serviceName, $ip, $port, $healthyOnly = false, $ephemeral = false, $namespaceId = "", $cluster = "")
    {
        try {
            ...
            $getInstanceDiscovery->setEphemeral($ephemeral);
     ...
     * @param $namespaceId
     * @param $beat
     * @return Beat|model\Host|Instance|InstanceList|model\Model
     * @throws ReflectionException
     * @throws RequestUriRequiredException
     * @throws RequestVerbRequiredException
     * @throws ResponseCodeErrorException
     */
    public static function beat($serviceName, $namespaceId, $beat)
    {
